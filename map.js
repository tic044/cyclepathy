...
mapboxgl.accessToken = 'pk.eyJ1IjoidGljMDQ0IiwiYSI6ImNtaHpseTVxMzBua2kya3E2M21nbng0cmIifQ.UEdxcXHZNuh4E3i1EII0qg';

const svg = d3.select('#map').select('svg');

let timeSlider, selectedTime, anyTimeLabel, timeFilter;
...
map.on('load', async () => {
    ...
    const circles = svg
        ...
        .enter()
        .append('circle')
        .attr('r', (d) => radiusScale(d.totalTraffic)) // Set the radius using the scale
